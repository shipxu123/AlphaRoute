...
run3d.run(device, train_dataset, valid_dataset, test_dataset,
        ...
        epochs=2, batch_size=1, vt_batch_size=1, lr=0.005, lr_decay_factor=0.5, lr_decay_step_size=15)
...
relaxer = AnalogRelaxation(cost_guide_distribution, potential_function, pool_size=1, max_iterations=3, max_outer_iterations=5)
relaxer.process()