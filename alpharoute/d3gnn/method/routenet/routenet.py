...
class RouteNet(torch.nn.Module):
    r"""
        The re-implementation for RouteNet from the `"RouteNet: A Continuous-filter Convolutional Neural Network for Modeling Quantum Interactions" <https://arxiv.org/abs/1706.08566>`_ paper
    ...
    def forward(self, data):
        z, g, pos, batch = data.nid, data.g, data.pos, data.batch
